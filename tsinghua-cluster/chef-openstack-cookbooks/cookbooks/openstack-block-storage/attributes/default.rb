...
default['openstack']['block-storage']['osapi_volume_workers'] = 4
...
default['openstack']['block-storage']['database']['max_pool_size'] = '100'
default['openstack']['block-storage']['database']['idle_timeout'] = '3600'
